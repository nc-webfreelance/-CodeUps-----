...
<div class="sub-mv js-mv-height">
  <div class="sub-mv__inner">
    <div class="sub-mv__image">
      <picture>
        <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-mv-campaign-pc.webp" type="image/webp" media="(min-width: 768px)" />
        <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-mv-campaign-pc.jpg" type="image/jpeg" media="(min-width: 768px)" />
        <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-mv-campaign-sp.webp" type="image/webp" media="(max-width: 767px)" />
        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/sub-mv-campaign-sp.jpg" alt="青空とシーサー" />
      </picture>
    </div>
  ...
  <div class="page-campaign__inner inner">
    <div class="page-campaign__tab category-tab">
      <ul class="category-tab__items">
        ...
        <!-- ループ処理開始 -->
        <?php
        $genre_terms = get_terms('campaign-category', array('hide_empty' => false));
        foreach ($genre_terms as $genre_term) :
        ?>
          <li class="category-tab__item <?php if($cat_name == esc_html($genre_term->name)){echo 'tab-active';} ?>">
